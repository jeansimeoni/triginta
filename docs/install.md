...
Triginta `0.1.1` is available through GitHub Releases, the shell installer,
...
```bash
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/jeansimeoni/triginta/releases/download/v0.1.1/triginta-installer.sh | sh
```
